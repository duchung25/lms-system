...
router.get('/:courseId/lessons', authMiddleware, readAccessMiddleware, lessonController.getLessonsByCourse);
router.get('/:courseId/lessons/:lessonId', authMiddleware, readAccessMiddleware, lessonController.getLessonById);
