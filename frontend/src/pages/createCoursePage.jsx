    ...
    return (
        <div className="container py-4 create-course-container">
            <div className="d-flex align-items-center justify-content-between mb-3">
                <h3 className="m-0 create-course-title">Thêm khóa học</h3>
            ...
            <form className="row g-4 create-course-form" onSubmit={handleSubmit}>
                ...
                <div className="col-md-6">
                    ...
                    <div className="col-12">
                        ...
                        <img
                            src={thumbnailUrl || "https://via.placeholder.com/160x120?text=Preview"}
                            alt="preview"
                        />
                        <input
                            type="file"
                ...
                <div className="col-12 text-end">
                    <button className="btn btn-primary create-course-btn" type="submit">Tạo khóa học</button>
                </div>
            </form>
        </div>
        );
